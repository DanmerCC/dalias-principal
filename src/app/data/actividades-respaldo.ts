// Datos ESTÁTICOS de respaldo para la vista de Actividades.
// Se usan solo cuando el CMS no devuelve actividades, para no romper el diseño.
// Fuente real: CMS (ver CmsService.getActividades).
...
export const ACTIVIDADES_RESPALDO: Noticia[] = [
  {
    id: '1',
    fecha: '15/01/2026',
