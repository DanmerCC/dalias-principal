...
@Component({
  selector: 'app-terapias-y-rehabilitacion',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './terapias-y-rehabilitacion.component.html',
  styleUrl: './terapias-y-rehabilitacion.component.css',
})
export class TerapiasYRehabilitacionComponent implements OnInit {
