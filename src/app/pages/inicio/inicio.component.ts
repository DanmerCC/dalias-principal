        ...
        .then((doc) => {
          ...
          this.ngZone.run(() => {
            this.banner = {
              ...
              imagenAreasVerdes: resolveImg(doc?.imagenAreasVerdes?.url) || this.banner.imagenAreasVerdes,
        ...
        .catch(() => {
          ...
          this.ngZone.run(() => {
            this.banner = {
              ...
              imagenAreasVerdes: resolveImg(incomingData?.imagenAreasVerdes?.url) || this.banner.imagenAreasVerdes,
